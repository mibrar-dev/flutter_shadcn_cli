...
extension InstallerPlatformAliasPart on Installer {
  ...
  Future<void> generateAliases() async {
    ...
    final classEntries = <String, _AliasEntry>{};
    ...
    final output = StringBuffer()
      ...
      ..writeln('');
    final hiddenMaterialNames = _materialNamesToHide(classEntries.keys);
    ...
    if (prefix != null && prefix.isNotEmpty) {
      ...
      output.writeln('');
      final aliasEntries = classEntries.entries.toList()
