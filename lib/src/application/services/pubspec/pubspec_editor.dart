...
class PubspecEditor {
  ...
  _SectionRange? _findSubSection(_SectionRange parent, String subKey) {
    final keyWithoutColon = subKey.endsWith(':')
  ...
  void _addMapEntries(
    ...
    final existing = section != null ? _collectSectionKeys(section) : <String>{};
    ...
    for (final entry in sortedEntries) {
      final formatted = _formatDependencyLines(
          entry.key, entry.value, childIndent);
